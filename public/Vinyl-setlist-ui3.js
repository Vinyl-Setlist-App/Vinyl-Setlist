(() => {
  ...
  async function hardResetAndReload() {
    ...
    if (window.currentSetlistFile && typeof window.loadSetlistIntoVinyl === 'function') {
      window.currentMode = "setlist";
      await window.loadSetlistIntoVinyl(window.currentSetlistFile);
    } else {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (typeof window.loadSetlistIntoVinyl === 'function') {
    const originalLoadSetlist = window.loadSetlistIntoVinyl;
    window.loadSetlistIntoVinyl = async function(file) {
      window.currentMode = "setlist";
